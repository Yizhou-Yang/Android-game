...
public abstract class GenericGenerator implements StartupGenerator {
     ...
     * Note, these functions are sepcial, as they take input in string form. This input should be the
    ...
    private Weapon generateWeaponClassRandom() {
        Random y = new Random();
        int x = y.nextInt(weaponClasses.length);
    ...
    private HealthPotion generateHealthPotionClassRandom() {
        Random y = new Random();
        int x = y.nextInt(healthPotionClasses.length);
    ...
    private Armor generateArmorClassRandom() {
        Random y = new Random();
        int x = y.nextInt(armorClasses.length);
