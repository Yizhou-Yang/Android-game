...
import com.example.cs_game.ItemListFragment;
...
public class CombatActivity extends AppCompatActivity implements CombatView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new CombatPresenter(this, user);
        presenter.onCreate();
    }
     ...
     */
    private void clearFragmentAllBackStack() {
     ...
     * Moreover, user should not be able to go back EquipmentActivity once combat starts
     */
    @Override
    ...
    /**
     * Update health by updating the ProgressBar referred by healthBarId to newHealh value
     *
     * @param healthBarId the id referring to the ProgressBar
     * @param newHealth   the new health that healthbar should take on
     */
     ...
     */
    @Override
    public void toNextLevel(String message, final int timeSpent, final int exp, final boolean won) {
        ...
        showDialogForNextActivity("To Next Level",
                message, listener);
    ...
    public void toMainMenu() {
        ...
        showDialogForNextActivity("To Main Menu",
                "You lost the battle.", listener);
    }

    /**
     * Show a dialog with one button to proceed to the next activity, which is given by type
     *
     * @param title    title of the dialog
     * @param message  message of the dialog
     * @param listener the listener for the button on dialog, which sends to the next activity
     *                 on click
     */
    private void showDialogForNextActivity(String title, String message,
    ...
    private void clearPlayer(String username) {
        ...
        //user.setLevel(2);
        user.setResources(GameManager.getPlayer().getResources() / 2);
